...
class _MenuItem<T> extends SingleChildRenderObjectWidget {
  ...
  final DropdownMenuItemOwn<T> item;
...
/// An item in a menu created by a [DropdownButtonOwn].
///
/// The type `T` is the type of the value the entry represents. All the entries
/// in a given menu must represent values with consistent types.
class DropdownMenuItemOwn<T> extends _DropdownMenuItemContainer {
  /// Creates an item for a dropdown menu.
  ///
  /// The [child] argument is required.
  const DropdownMenuItemOwn({
    Key key,
    this.value,
  ...
  ///
  /// Eventually returned in a call to [DropdownButtonOwn.onChanged].
  final T value;
}

/// An inherited widget that causes any descendant [DropdownButtonOwn]
/// widgets to not include their regular underline.
///
/// This is used by [DataTable] to remove the underline from any
/// [DropdownButtonOwn] widgets placed within material data tables, as
...
class DropdownButtonHideUnderline extends InheritedWidget {
  ...
  /// Returns whether the underline of [DropdownButtonOwn] widgets should
  /// be hidden.
...
/// Typically, an enum is used. Each [DropdownMenuItemOwn] in [items] must be
...
/// See also:
///
///  * [DropdownMenuItemOwn], the class used to represent the [items].
///  * [DropdownButtonHideUnderline], which prevents its descendant dropdown buttons
///    from displaying their underlines.
///  * [RaisedButton], [FlatButton], ordinary buttons that trigger a single action.
///  * <https://material.io/design/components/menus.html#dropdown-menu>
class DropdownButtonOwn<T> extends StatefulWidget {
  ...
  DropdownButtonOwn({
    ...
    this.autofocus = false,
      ...
      items.where((DropdownMenuItemOwn<T> item) {
  ...
  /// be displayed.
  final List<DropdownMenuItemOwn<T>> items;

  /// The value of the currently selected [DropdownMenuItemOwn].
  ///
  ...
  /// [DropdownMenuItemOwn]s in [items].
  ///
  /// When a [DropdownMenuItemOwn] is selected, the widget that will be displayed
  /// from the list corresponds to the [DropdownMenuItemOwn] of the same index
  /// in [items].
  ///
  /// {@tool snippet --template=stateful_widget_scaffold}
  ///
  /// This sample shows a `DropdownButton` with a button with [Text] that
  /// corresponds to but is unique from [DropdownMenuItemOwn].
  ///
  /// ```dart
  ...
  /// {@end-tool}
  ///
  /// If this callback is null, the [DropdownMenuItemOwn] from [items]
  ...
  @override
  _DropdownButtonOwnState<T> createState() => _DropdownButtonOwnState<T>();
}

class _DropdownButtonOwnState<T> extends State<DropdownButtonOwn<T>> with WidgetsBindingObserver {
  int _selectedIndex;
  ...
  @override
  void didUpdateWidget(DropdownButtonOwn<T> oldWidget) {
  ...
  void _updateSelectedIndex() {
    ...
    assert(widget.value == null ||
        widget.items.where((DropdownMenuItemOwn<T> item) => item.value == widget.value).length == 1);
    _selectedIndex = null;
...
/// A convenience widget that wraps a [DropdownButtonOwn] in a [FormField].
class DropdownButtonFormField<T> extends FormField<T> {
  /// Creates a [DropdownButtonOwn] widget wrapped in an [InputDecorator] and
  /// [FormField].
  ///
  ...
  DropdownButtonFormField({
    Key key,
    T value,
    @required List<DropdownMenuItemOwn<T>> items,
